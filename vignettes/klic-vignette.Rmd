...
```{r lmk_kmeans, eval = FALSE, fig.show='hold', warning=FALSE, cache=TRUE}
...
```{r ari, eval = FALSE, fig.show='hold', warning=FALSE, cache=TRUE}
...
```{r maximise_silhouette, eval = FALSE, fig.show='hold', warning=FALSE, cache=TRUE}
...
```{r klic, eval = FALSE, fig.show='hold', warning=FALSE, cache=TRUE}
...
```{r k_kmeans, eval = FALSE, fig.show='hold', message=FALSE, warning=FALSE, cache=TRUE}
